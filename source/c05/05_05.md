...
2007年诞生，ruby语言开发，最成熟最稳定的css扩展语言          

less: <https://less.bootcss.com>           
2009年诞生，给css加点料             

stylus: <https://stylus.bootcss.com/>           
2010年诞生，来源于nodejs社区，有表现力、动态、健壮的css         
...
##### 4. 作用域 scoped
Sass中作用域在这三款预处理器是最差的，不存在什么全局变量
```
$color: black;
.scoped {
  $bg: blue;
...
##### 10. 运算符
Stylus的运算是三款预处理器语言中最强大的一款，其次sass，最后less
```
// less
@base_margin: 10px;
